...
import { KeyboardCodes, Modifiers } from '@renderer/libs/keyboard'
...
export const Shortcut = ({ label, modifiers = {}, keyCode }: ShortcutProps): ReactElement => {
  ...
  async function send(mods: Modifiers, code: number): Promise<void> {
